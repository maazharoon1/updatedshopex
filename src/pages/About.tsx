...
const About = ({ embedded = false }: AboutProps) => {
  useSeo({
    title: "About — ShopEx Studio",
    description:
      "ShopEx Studio is an independent creative studio specializing in brand identity, illustration, and visual design.",
    enabled: !embedded,
  });
        ...
        <div className="max-w-3xl space-y-12">
          ...
          <div>
            ...
            <div className="space-y-6 text-lg md:text-xl leading-relaxed text-muted-foreground animate-fade-in-up" style={{ animationDelay: "0.1s" }}>
              <p>
                <span className="text-foreground">ShopEx Studio</span> is an independent creative 
